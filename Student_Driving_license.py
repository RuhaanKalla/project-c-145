...
# Define the function
def show():
    label_id["text"] = "1238746092"
    label_name["text"] = "Ruhaan Kalla"
    label_dob["text"] = "14th April 2009"
    label_pin["text"] = "122001"
    label_address["text"] = "avalon heights, Gurgaon"
    label_vehicle_type["text"] = "two four"
    
    
    
# Create a button
button1 = Button(root,text="Student Driving License",command = show)
